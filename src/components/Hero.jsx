  ...
  return (
    <section className="relative overflow-hidden border-b border-[var(--border)]">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-5 py-16 sm:px-8 sm:py-20 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)] lg:gap-20 lg:py-28">
        ...
        <aside className="relative self-end animate-fade-in" aria-label="Student profile information">
          ...
          <div className="absolute -bottom-5 -left-5 w-44 rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-4 shadow-[0_18px_45px_-28px_var(--shadow)] sm:-left-8">
            <p className="text-[9px] font-bold uppercase tracking-[0.16em] text-[var(--muted)]">note</p>
            <p className="mt-2 text-xs leading-5 text-[var(--text-secondary)]">A living record of learning, practice, and reflection.</p>
          </div>
        </aside>
      </div>
    </section>
